            ...
            <center>
                <h2 align ="center" style="height: 50px; text-align: center; color: red;">Your Ride Details <span id="riderdetails"></span></h2>
                    ...
                    <div id="admin" style="display: none;">
                        <div>
                            <div>
                                <p style="float: left;">Select Rider</p>
                                <select name="rider" id="">
                                    <option value="dharampal">Dharampal</option>
                                    <option value="karan">Karan</option>
                                    <option value="lalit">Lalit</option>
                                </select>
                            </div><br>
                            <p style="float: left;">Select Month</p>
                        ...
                        <br>
                        <div>
                            <p style="float: left;">Select Year</p>
                        ...
                        <div>
                            <button style="height: 30px; width: 80px; color: red; background-color: yellow;" id="show">Show</button>
                            <button style="height: 30px; width: 80px; color: red; background-color: yellow;" id="print">Print</button>
                        </div>
                        <br><br>
                        <div id="listview" style="height: 200px; width: 500px; background-color: blue; display: none;"></div>
                    </div>
                <br><br>
  ...
  const firebaseConfig = {
    ...
    onAuthStateChanged(auth, (user) => {
      if(user) {
        ...
        if(userName.innerHTML == "Dharampal"){
                ...
                if(userName.innerHTML == "Mirchi Tasks"){
                    ...
                    if(userName.innerHTML == "Happykart"){
